...
from hybrid_star.stability import set_Lagragian_vars_at_interface
from hybrid_star.structure import HybridStar, phase_splitting_interface
...
class HybridStarStabilityFactory(StarStabilityFactory):
    ...
    def set_rad_osc_input(
        ...
        self._rad_osc_sol1 = solve_rad_osc(
            self.omega_squared_guess, rad_osc_input1)
