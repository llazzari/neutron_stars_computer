...
from star.tov_solver import Array, TOVInput, solve_tov
from star.stability import CentralRadOscInput, RadOscInput, Stability
from star.structure import InternalProfiles, Star, interpol_tov, tov_coeffs
...
class StarStabilityFactory:
    ...
    def set_rad_osc_input(
        ...
        return RadOscInput(
            ...
            tov_spline=functools.partial(
                tov_coeffs,
                interpolated_tov=interpolated_tov
            ),
    ...
    def set_internal_profiles(self) -> InternalProfiles:
        ...
        time_metric_fn = np.delete(
            self.ip.time_metric_fn, -1)
